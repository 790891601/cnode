...
const books = [
  {
    title: "Node.js 入门",
    content: `
      <div><p>《<strong>快速搭建 Node.js 开发环境以及加速 npm</strong>》</p>
      ...
      <p><a href="https://github.com/nqdeng/7-days-nodejs" target="_blank">https://github.com/nqdeng/7-days-nodejs</a></p></div>
    `
  },
  {
    title: "Node.js 资源",
    content: `
      <div><p>《<strong>前端资源教程</strong>》</p>
      ...
      <p><a href="https://github.com/pana/node-books" target="_blank">https://github.com/pana/node-books</a></p></div>
    `
  },
  {
    title: "Node.js 名人",
    content: `
      <div><p>《<strong>名人堂</strong>》</p>
      <p><a href="https://github.com/cnodejs/nodeclub/wiki/%E5%90%8D%E4%BA%BA%E5%A0%82" target="_blank">https://github.com/cnodejs/nodeclub/wiki/名人堂</a></p></div>
    `
  },
  {
    title: "Node.js 服务器",
    content: `
      <div><p>新手搭建 Node.js 服务器，推荐使用无需备案的 <a href="https://www.digitalocean.com/?refcode=eba02656eeb3" target="_blank">DigitalOcean(https://www.digitalocean.com/)</a></p></div>
    `
  }
]
    ...
    return <div className="center">
      {
        books.map((book, index) => 
          <Card key={index} title={book.title}>
            <div className="card-content">
              {
                <div className="acrile" dangerouslySetInnerHTML={{__html: book.content}}></div>
              }
            </div>
          </Card>
        )
